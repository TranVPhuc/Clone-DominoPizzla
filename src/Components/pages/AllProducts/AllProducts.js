...
const AllProducts = () => {
 ...
 const handleChange = (value) => {
   setData(dataProduct.filter((data) => data.tags.includes(value)));
 };
  ...
  const formik = useFormik({
    ...
    onSubmit: (values, { resetForm }) => { 
      if (dataDetail){
        ...
        setData([...data, { ...values, key: Date.now(), tags: [values.tags] }]);
        dataProduct = [...data, { ...values, key: Date.now(), tags: [values.tags] }];
      }
