  ...
  return (
    <div className='bg-[#222222] mb-[10px]'>
      <div className='relative'>
        <a href='#'>
        <img alt=''
          className='w-full h-[80vh] mb-2' src={require('../img/imgbanner1.jpg')} />
        <div className='absolute z-10 top-16 text-center left-1/3 '>
          ...
          <div className='text-white flex items-center justify-evenly'>
            <a href='#' className='text-2xl no-underline text-white font-light hover:underline '>Learn more</a>
            <a href='#' className='text-2xl no-underline text-white font-light hover:underline '>Buy now!</a>
          </div>
        </div>
      </a>
      </div>
       ...
       <div className='relative'>
        <a href='#'>
        <img alt=''
          className='w-full h-[80vh] mb-2 z-10'
          src={require('../img/imgbanner2.webp')} />
        <div className='absolute z-10 text-center top-9 left-[25%]'>
          ...
          <a href='#' className='text-2xl no-underline text-white hover:underline font-light'>Shop Now</a>
        </div>
      </a>
      </div>
      ...
      <div  className='relative'>
          <a href='#'>
          <img alt=''
          className='w-full h-[75vh] mb-2' src={require('../img/imgbanner3.webp')} />
        <div className='absolute z-10 text-center left-[30%] top-9'>
          ...
          <div className='flex items-center justify-evenly'>
            <a href='#' className='text-2xl no-underline text-white hover:underline font-light'>Learn more</a>
            <a href='#' className='text-2xl no-underline text-white hover:underline font-light'>Buy now!</a>
          </div>
        </div>
      </a>
      </div>
      ...
      <div className='flex justify-between mb-2' >
        <div className='relative' >
          <a href='#'>
            <img alt=''
          className='w-full h-[62.5vh]' src={require('../img/imgbanner4.webp')} />
          <div className='text-center absolute top-12 left-32'>
              ...
              <a href='#' className='text-2xl no-underline text-white hover:underline font-light text-lg'>Sign Up Now</a>
            </div>
          </a>
        ...
        <div className='relative'>
          <img alt=''
            className='w-full h-[62.5vh]' src={require('../img/imgbanner5.webp')} />
          ...
          <div className='flex items-center justify-evenly'>
            <a href='#' className='text-2xl no-underline text-white hover:underline font-light text-lg'>Learn more</a>
            <a href='#' className='text-2xl no-underline text-white hover:underline font-light text-lg'>Buy now!</a>
          </div>
        </div>
        </div>
      </div>
     ...
     <div className='flex justify-between mb-2'>
          <div className='relative' >
          <img alt=''
            className='w-full h-[62.5vh]' src={require('../img/imgbanner6.webp')} />
          <div className='text-white text-center absolute top-12 left-[4%]'>
            ...
            <div className='flex items-center justify-evenly'>
              <a href='#' className='text-2xl no-underline text-white hover:underline font-light text-lg'>Razer Blade 16</a>
              <a href='#' className='text-2xl no-underline text-white hover:underline font-light text-lg'>Razer Blade 18</a>
          </div>
            </div>
        </div>
        ...
        <div className='relative'>
          <img alt=''
            className='w-full h-[62.5vh]' src={require('../img/imgbanner7.webp')} />
       ...
       <div className='flex justify-between'>
          <div className='relative' >
          <img alt=''
          className='w-full h-[62.5vh]' src={require('../img/imgbanner8.webp')} />
        ...
        <div className='relative'>
          <img alt=''
            className='w-full h-[62.5vh]' src={require('../img/imgbanner9.webp')} />
